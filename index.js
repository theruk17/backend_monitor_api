...
app.put('/edit/:id' , (req, res) => {
  ...
  connection.query(
    ...
    [req.body.group, req.body.brand, req.body.model, req.body.size, req.body.hz, req.body.panel, req.body.resolution,req.body.price_srp, req.body.price, req.body.id], (err, result) => {
      if(err) throw err
