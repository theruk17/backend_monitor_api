...
app.put('/edit/:id' , (req, res) => {
  ...
  const { group, brand, model } = req.body
  connection.query(
    ...
    [group, brand, model, req.body.size, req.body.hz, req.body.panel, req.body.resolution,req.body.price_srp, req.body.price, id], (err, result) => {
      if(err) throw err
